...
- Read-only Legacy Imports preserve pre-session scanner rows outside current research, with demo-origin imports available only through an explicit demo context.
